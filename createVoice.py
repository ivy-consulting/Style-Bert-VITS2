...
def voice(text: str, model_id: int, model_holder: TTSModelHolder, **kwargs) -> Optional[BytesIO]:
...
def createVoice(text: str):
    ...
    model_id = 0  # Set the desired model ID

    try:
        audio_data = voice(text, model_id, model_holder)
